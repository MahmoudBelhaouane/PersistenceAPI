...
class Database{
	...
	private $db_prefixe;	// Change as required
    ...
    return $this->db_prefixe;
    }
	// Function to make connection to database
	public function connect(){
    $config =  parse_ini_file('config.ini'); 
    $this->db_host = $config['host'];  // Change as required
	$this->db_user = $config['username'];  // Change as required
	$this->db_pass = $config['password'];  // Change as required
	$this->db_name = $config['dbname'];	// Change as required
	$this->db_prefixe = $config['prefixe'];	// Change as required
